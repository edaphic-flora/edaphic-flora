          ...
          card_body(
            ...
            div(class = "p-3 bg-light rounded border-start border-3",
                ...
                p(class = "text-muted mb-0 mt-1",
                  ...
                  tags$a(href = "https://extension.org/find-cooperative-extension-in-your-state/",
        ...
        card(
          ...
          card_body(
            ...
            p(class = "text-muted mb-4",
              ...
              tags$a(href = "https://www.nifa.usda.gov/about-nifa/what-we-do/extension/cooperative-extension-system", target = "_blank", "university extension services"),
