 ...
 header = tagList(
   ...
   tags$head(
    ...
    tags$meta(property = "og:image",
              content = "https://edaphicflora.shinyapps.io/edaphic-flora/screenshot_welcome.png"),
    tags$meta(property = "og:url", content = "https://edaphicflora.shinyapps.io/edaphic-flora/"),
